...
public class ExportWord {
     ...
     * 创建表格的标题样式
     * @param document
     * @Author daxv 2018年12月16日 下午5:28:38
     */
...
//        xwpfHelperTable.createTable(xdoc, rowSize, cellSize, isSetColWidth, colWidths)
    ...
    public void exportCheckWord(Map<String, Object> dataList, XWPFDocument document, String savePath) throws IOException, IOException {
