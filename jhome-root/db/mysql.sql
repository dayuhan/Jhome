...
INSERT INTO `mysqlDb`.`cs_registered_config` (`id`, `paramName`, `key`, `value`, `application`, `isEnable`, `profile`, `label`, `createTime`, `createBy`, `updateTime`, `updateBy`, `isPublicComponent`) VALUES ('89eb12c8-b8e2-4b17-87c7-f9a6bfc918ba', '数据库配置-地址', 'spring.datasource.url', 'jdbc:mysql://192.168.52.130:3306/mysqlDb?serverTimezone=UTC&useSSL=false', 'jhome-web', '0', 'dev', 'master', '2020-08-22 09:23:11', 'admin', '2020-08-22 09:23:11', 'admin', '0');
...
INSERT INTO `mysqlDb`.`cs_registered_config` (`id`, `paramName`, `key`, `value`, `application`, `isEnable`, `profile`, `label`, `createTime`, `createBy`, `updateTime`, `updateBy`, `isPublicComponent`) VALUES ('89eb12c8-b8e2-4b17-87c7-f9a6bfc918bc', '任务链tomcat-端口号', 'server.port', '8200', 'jhome-web', '0', 'dev', 'master', '2020-08-22 09:23:11', 'admin', '2020-08-22 09:23:11', 'admin', '0');
...
INSERT INTO `mysqlDb`.`cs_registered_config` (`id`, `paramName`, `key`, `value`, `application`, `isEnable`, `profile`, `label`, `createTime`, `createBy`, `updateTime`, `updateBy`, `isPublicComponent`) VALUES ('89eb12c8-b8e2-4b17-87c7-f9a6bfc918bm', 'redis配置-地址', 'spring.redis.host', '192.168.52.130', 'jhome-web', '0', 'dev', 'master', '2020-08-22 09:23:11', 'admin', '2020-08-22 09:23:11', 'admin', '1');
...
INSERT INTO `mysqlDb`.`cs_registered_config` (`id`, `paramName`, `key`, `value`, `application`, `isEnable`, `profile`, `label`, `createTime`, `createBy`, `updateTime`, `updateBy`, `isPublicComponent`) VALUES ('89eb12c8-b8e2-4b17-87c7-f9a6bfc918bq', 'redis配置-密码', 'spring.redis.password', '123456', 'jhome-web', '0', 'dev', 'master', '2020-08-22 09:23:11', 'admin', '2020-08-22 09:23:11', 'admin', '1');
INSERT INTO `mysqlDb`.`cs_registered_config` (`id`, `paramName`, `key`, `value`, `application`, `isEnable`, `profile`, `label`, `createTime`, `createBy`, `updateTime`, `updateBy`, `isPublicComponent`) VALUES ('89eb12c8-b8e2-4b17-87c7-f9a6bfc918br', '注册中心配置-地址', 'eureka.client.serviceUrl.defaultZone', 'http://daxunihao:123456@127.0.0.1:9100/jhome/eureka/', 'jhome-web', '0', 'dev', 'master', '2020-08-22 09:23:11', 'admin', '2020-08-22 09:23:11', 'admin', '1');
INSERT INTO `mysqlDb`.`cs_registered_config` (`id`, `paramName`, `key`, `value`, `application`, `isEnable`, `profile`, `label`, `createTime`, `createBy`, `updateTime`, `updateBy`, `isPublicComponent`) VALUES ('89eb12c8-b8e2-4b17-87c7-f9a6bfc918bs', '注册中心配置-当前服务部署地址', 'eureka.instance.ipAddress', '127.0.0.1', 'jhome-web', '0', 'dev', 'master', '2020-08-22 09:23:11', 'admin', '2020-08-22 09:23:11', 'admin', '1');
...
INSERT INTO `mysqlDb`.`cs_registered_config` (`id`, `paramName`, `key`, `value`, `application`, `isEnable`, `profile`, `label`, `createTime`, `createBy`, `updateTime`, `updateBy`, `isPublicComponent`) VALUES ('89eb12c8-b8e2-4b17-87c7-f9a6bfc918by', '数据库配置-密码', 'spring.datasource.password', '123456', 'jhome-web', '0', 'dev', 'master', '2020-08-22 09:23:11', 'admin', '2020-08-22 09:23:11', 'admin', '0');
