 ...
 * 文件读写
 */
public class FileOprUtils implements Serializable{
    ...
    public static Map<String, String> cutPhotoFromVedio(String dealDir, String videoPath) {
        ...
        String srcImgPath = dealDir + File.separator + StringUtil.getNameWithoutExtension(videoPath) + ".jpg";
        String thumbImagePath = dealDir + File.separator + StringUtil.getNameWithoutExtension(videoPath) + "Thumb.jpg";
        try {
    ...
    public static String compressFromImage(String dealDir, MultipartFile file) {
        ...
        String thumbImagePath = dealDir + File.separator + StringUtil.getFileNameByPath(fileName);
